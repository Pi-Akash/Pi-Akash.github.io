...
//Pi-Akash/Pi-Akash.github.io/blob/master/data/timeline.json
//https://raw.githubusercontent.com/c-c-l/D3ITL/master/data/timeline.json
//https://raw.githubusercontent.com/Pi-Akash/Pi-Akash.github.io/master/data/timeline.json
function drawChart() {
  const svg = d3.select(" #timelineChart").append("svg").attr('id','Chart').attr("width", '100%').attr("height", 320);
  d3.json("https://raw.githubusercontent.com/Pi-Akash/Pi-Akash.github.io/master/data/timetwo.json").then(function(data) {
    ...
    group.append('circle')
      ...
      .on('mouseover', function(d, i) {
        ...
        //added code to change the appearence of the text
        d3.select(this.parentNode).selectAll('text').style('font-weight', "bold");
      ...
      .on('click', function(d, i){
        ...
        d3.selectAll('.details').style('text-align', 'left');
        setTimeout(function() {
          svg.attr('height', 0);
        }, 450)
